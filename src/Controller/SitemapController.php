...
class SitemapController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        $urls[] = ['loc' => $this->generateUrl('app_project_indexsymfony')];
        $urls[] = ['loc' => $this->generateUrl('app_project_indexangular')];
        $urls[] = ['loc' => $this->generateUrl('app_project_indexwordpress')];
